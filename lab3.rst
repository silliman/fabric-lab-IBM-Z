...
**Step 4.1:** In each of the PuTTY or SSH sessions where you started the UI application (via *gulp marblesx*) enter **Ctrl-c** to end each session.  Exit from, ignore, fold, spindle, or mutilate one of the two sessions, treat it however you wish. The rest of the commands in this section can be performed from the other session.

**Step 4.2:** Navigate to *~/zmarbles*::

 bcuser@ubuntu16044:~/zmarbles/marblesUI$ cd ~/zmarbles
 bcuser@ubuntu16044:~/zmarbles$ 

**Step 4.3:** Stop the Hyperledger Fabric network::

 bcuser@ubuntu16044:~/zmarbles$ docker-compose down
 Stopping cli ... done
...
**Step 4.5:** Run this command to remove all containers::
 ...
 bcuser@ubuntu16044:~/zmarbles$ docker rm $(docker ps -aq)
 c776759144ed
 bc45f38fd7e8
 562b9a662bd8
...
**Step 4.7:** Remove the chaincode Docker images.  First, display them::
 ...
 bcuser@ubuntu16044:~/zmarbles$ docker images dev-*
...
**Step 4.8:** This command removes the chaincode Docker images::
 ...
 bcuser@ubuntu16044:~/zmarbles$ docker rmi $(docker images -q dev-*)
